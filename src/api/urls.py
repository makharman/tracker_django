...
urlpatterns = [
    ...
    path('expenses/<int:pk>/', ExpenseEditModelSerializer.as_view(), name='expense-detail-update'),
    path('incomes/<int:pk>/', IncomeEditModelSerializer.as_view(), name='income-detail-update'),
